...
!(function (t, e) {
        ...
        if (t !== r || e !== h) {
            ...
            for (I = 0; I < L; I++)
                (_ = W((s = N + I * G))),
                    ...
                    (D = W((s += G))),
                    (k = j(s)),
                    X.push(_ - B * m, m + B * _, D + B * k, k - B * D, D, k);
        ...
        for (e = 0; e < y; e++)
            if (
                ...
                (c = b),
                    (d = v),
                    ("C" !== g && "S" !== g) ||
                        ((c += b - r[r.length - 4]), (d += v - r[r.length - 3])),
                    o || (b = v = 0),
                    r.push(c, d, i, s, (b += 1 * _[e + 3]), (v += 1 * _[e + 4])),
                    (e += 4);
            else if ("Q" === a)
                (c = b + (2 / 3) * (i - b)),
                    (d = v + (2 / 3) * (s - v)),
                    ...
                    (b += 1 * _[e + 3]),
                    (v += 1 * _[e + 4]),
                    r.push(c, d, b + (2 / 3) * (i - b), v + (2 / 3) * (s - v), b, v),
                    (e += 4);
            else if ("T" === a)
                (c = b - r[r.length - 4]),
                    (d = v - r[r.length - 3]),
    ...
    function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
        ...
        return (
            ...
            h * (S * S + C * C) < (x + E) * (x + E) &&
                ((d = l.length),
                bezierToPoints(t, e, u, g, b, v, P, w, h, l, c),
                bezierToPoints(P, w, y, A, _, m, o, r, h, l, c + 2 + (l.length - d))),
            l
        );
    }
    function pointsToSegment(t, e, n) {
        ...
        var i,
            ...
            S = A - v,
            C = P - y,
            x = Math.abs(t[b] - v) < 0.001 && Math.abs(t[b + 1] - y) < 0.001;
        for (
                ...
                (v === A && y === P) ||
                    ...
                    (v === i && y === s) ||
                        (n < a
                            ...
                            : ((r = E(d, l)),
                              w.push(o(v - W(r) * g), o(y - j(r) * g)),
                              (r = E(C, S)),
                              w.push(o(v), o(y), o(v + W(r) * p), o(y + j(r) * p)))));
        return (
            v !== A || y !== P || w.length < 4 ? w.push(o(A), o(P), o(A), o(P)) : (w.length -= 2),
            x && (w.splice(0, 6), (w.length = w.length - 6)),
            w
        );
    }
        ...
        for (A = P; y <= s; )
            (p =
                (f =
                    ...
                    e) *
                    f +
                (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * g - n) *
                    _) < A && ((A = p), (v = y)),
                (y += b);
        return 1 < t
    ...
    function C(t) {
        ...
        if (((f = window), (y = new R()), e)) {
            (m = (g = e).documentElement),
                (b = e.body),
                ((x = g.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform =
                    "none");
                ...
                e &&
                    (n
                        ...
                        : (u || ((u = K(t)).style.cssText = r),
                          (h.style.cssText =
                              r + "width:0.1px;height:0.1px;top:" + o + "px;left:" + a + "px"),
                          u.appendChild(h))),
                h
            );
        }
    ...
    function N(t, e) {
        var n,
            ...
            d = t.parentNode;
        if (t === f) return t;
        if ((c.length || c.push(K(t, 1), K(t, 2), K(t, 3)), (n = h ? v : u), h))
            l
                ? ((a =
                ...
                r.left +
                    (d
                        ...
                        : (function _getDocScrollLeft() {
                              return (
                                  f.pageXOffset || g.scrollLeft || m.scrollLeft || b.scrollLeft || 0
                              );
                          })()),
                r.top +
                    (d
                        ...
                        : (function _getDocScrollTop() {
                              return (
                                  f.pageYOffset || g.scrollTop || m.scrollTop || b.scrollTop || 0
                              );
                          })())
            );
    ...
    function Na(t, e) {
        ...
        if (
            ...
            if (
                ...
                h ||
                    (Ba(L, "mouseup", n._onRelease),
                    t && t.target && Ba(t.target, "mouseup", n._onRelease)),
                o
                    ? (n.isDragging = !1)
            ...
            (dt.init = function init() {
                ...
                if (((this._rawPath = i), a)) {
                    if (((this._anchors = Oa(i, 0, this, o)), 1 < (t = i.length)))
                        for (e = 1; e < t; e++)
                            this._anchors = this._anchors.concat(Oa(i, e, this, o));
                    ...
                    (L = document),
                        ...
                        (V = (function (t) {
                            for (
                                var e = t.split(","),
                                    n = (
                                        void 0 !== q.onpointerdown
                                            ? "pointerdown,pointermove,pointerup,pointercancel"
                                            : void 0 !== q.onmspointerdown
    ...
    (ut.simplifyPoints = simplifyPoints),
        ...
        (ut.simplifySVG = function (t, e) {
            ...
            if (
                ...
                (i =
                    !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match($)),
                !1 !== e.curved)
            ) {
    ...
    function mb(t, e, n) {
        return fb(t) && St.test(t)
            ? ft.querySelector(t)
            : Array.isArray(t)
            ? yt(vt([{ x: gt.getProperty(e, "x"), y: gt.getProperty(e, "y") }].concat(t), n))
            : fb(t) || (t && "path" === (t.tagName + "").toLowerCase())
            ? t
            : 0;
    }
    function rb(t, e) {
                ...
                var e =
                        0 ===
                            (window ? window.location.href : "").indexOf(
                                bb(102, 105, 108, 101, 58, 47, 47)
                            ) ||
                        -1 !== t.indexOf(bb(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
                        -1 !== t.indexOf(bb(49, 50, 55, 46, 48, 32, 48, 46, 49)),
                    n = [
                        wt,
                        bb(99, 111, 100, 101, 112, 101, 110, 46, 105, 111),
                        bb(
                            99,
                            111,
                            100,
                        ...
                        bb(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
                        bb(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
                        bb(112, 101, 110, 115, 46, 99, 108, 111, 117, 100),
                        bb(99, 115, 115, 45, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
                        bb(99, 100, 112, 110, 46, 105, 111),
                        bb(112, 101, 110, 115, 46, 105, 111),
                        bb(103, 97, 110, 110, 111, 110, 46, 116, 118),
                        bb(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116),
                        bb(
                            116,
                            104,
                            101,
                        ...
                        bb(99, 101, 114, 101, 98, 114, 97, 120, 46, 99, 111, 46, 117, 107),
                        bb(116, 121, 109, 112, 97, 110, 117, 115, 46, 110, 101, 116),
                        bb(116, 119, 101, 101, 110, 109, 97, 120, 46, 99, 111, 109),
                        bb(116, 119, 101, 101, 110, 108, 105, 116, 101, 46, 99, 111, 109),
                        bb(112, 108, 110, 107, 114, 46, 99, 111),
                        bb(104, 111, 116, 106, 97, 114, 46, 99, 111, 109),
                        bb(119, 101, 98, 112, 97, 99, 107, 98, 105, 110, 46, 99, 111, 109),
                        bb(97, 114, 99, 104, 105, 118, 101, 46, 111, 114, 103),
                        bb(99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111),
                        bb(99, 115, 98, 46, 97, 112, 112),
                        bb(115, 116, 97, 99, 107, 98, 108, 105, 116, 122, 46, 99, 111, 109),
                        bb(99, 111, 100, 105, 101, 114, 46, 105, 111),
                        bb(
                            109,
                            111,
                            116,
                        ...
                        bb(106, 115, 102, 105, 100, 100, 108, 101, 46, 110, 101, 116)
                    ],
                    i = n.length;
                for (
                    setTimeout(function () {
                        window &&
                            ...
                            !window._gsapWarned &&
                            gt &&
                            !1 !== gt.config().trialWarn &&
                            (console.log(
                                bb(37, 99, 87, 97, 114, 110, 105, 110, 103),
                                bb(
                                    102,
                                    111,
                                    110,
                ...
                e ||
                    setTimeout(function () {
                        window.location.href =
                            bb(104, 116, 116, 112, 115, 58, 47, 47) +
                            wt +
                            bb(
                                47,
                                114,
    ...
    function MotionPathHelper(t, e) {
        ...
        t instanceof gt.core.Tween
            ...
            l && !i && (i = mb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
