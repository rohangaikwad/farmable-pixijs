...
function setupAnimations() {
    ...
    let lBGCircle6_1 = createCircle(color_lightGray, 10, lCircleXPos, 395 + lItemH / 2);
    let lBGCircle6_2 = createCircle(color_lightGray, 10, 334, 259);
    ...
    let lBGCircle7_2 = createCircle(color_lightGray, 10, 345, 289);

    let rLinePathX = 450;
    let rLinePathEndX = 590;

    createCircle(color_lightGreen, 10, rLinePathX, 231);
    let rBGCircle_l2_1 = createCircle(color_lightGray, 10, rLinePathX, 259);
    ...
    let rBGCircle4_2 = createCircle(color_lightGray, 10, rLinePathEndX, 259);
    let rBGCircle5_2 = createCircle(color_lightGray, 10, rLinePathEndX, 259 + 97 + rl5Offset);
    ...
    let lCircle7 = createCircle(color_lightOrange, 3, 345, 289, color_darkGray, 2.5);
